  ...
  return (
    ...
    >
      <form
        ...
        className="rounded-xl  bg-gray-300 bg-opacity-10 text-white shadow-xl flex flex-col justify-center  px-20 py-10 gap-y-5 sm:px-10 xs:px-6"
      ...
      >
        ...
        <button
          type="submit"
          style={{ width: "100%" }}
          className="mt-8 animate duration-300 py-[6px] w-32 rounded-md hover:bg-blue-500 text-white bg-[#026EF0] shadow-xl text-sm sm:mt-2"
        >
          Sign in
        </button>
      </form>
